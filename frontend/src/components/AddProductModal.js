...
const AddProductModal = ({ isOpen, onClose, sellingPointId, sellingPointName, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.msg || 'Ошибка при добавлении товара');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <Modal 
            isOpen={isOpen} 
            onClose={onClose} 
            title={`Добавить товар в "${sellingPointName}"`}
        >
